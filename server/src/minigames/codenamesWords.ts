// Single-word cards for Codenames. Classic-style, concrete, guessable nouns.
export const CODENAMES_WORDS: string[] = [
  "AFRICA", "AGENT", "AIR", "ALIEN", "AMAZON", "ANGEL", "APPLE", "ARM",
  "BANK", "BAR", "BEACH", "BEAR", "BED", "BELL", "BERLIN", "BOND", "BOOM",
  "BOOT", "BOTTLE", "BOW", "BOX", "BRIDGE", "BUCK", "BUG", "BUTTON",
  "CANADA", "CAP", "CAR", "CARD", "CAT", "CELL", "CENTAUR", "CHAIR",
  "CHANGE", "CHECK", "CHEST", "CHICK", "CHINA", "CHOCOLATE", "CIRCLE",
  "CLIFF", "CLOAK", "CLUB", "CODE", "COLD", "COMIC", "COMPOUND", "COOK",
  "COPPER", "COTTON", "COURT", "COVER", "CRANE", "CROWN", "CYCLE", "CZECH",
  ...
  "ENGLAND", "EYE", "FACE", "FAIR", "FALL", "FAN", "FENCE", "FIELD", "FIGHTER",
  ...
  "LITTER", "LOCH", "LOCK", "LOG", "LONDON", "LUCK", "MAIL", "MAMMOTH",
  "MAPLE", "MARBLE", "MARCH", "MASS", "MATCH", "MERCURY", "MEXICO",
  ...
  "SATURN", "SCALE", "SCHOOL", "SCIENTIST", "SCORPION", "SCREEN", "SCUBA",
  "SEAL", "SERVER", "SHADOW", "SHAKESPEARE", "SHARK", "SHIP", "SHOE", "SHOP",
  "SHOT", "SINK", "SKYSCRAPER", "SLIP", "SLUG", "SMUGGLER", "SNOW", "SOCK",
